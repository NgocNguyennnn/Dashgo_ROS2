...
def generate_launch_description():
    ...
    dashgo_driver_config_imu = os.path.join(
        get_package_share_directory('dashgo_driver'), 'config', 'my_dashgo_params_imu.yaml'
    )
    ...
    imu_launch_file = os.path.join(
        get_package_share_directory('dashgo_nav'), 'launch', 'imu.launch.py'
    )
    ...
    return LaunchDescription([
        ...
        # Declare launch arguments for velocity smoother
